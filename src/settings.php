...
<div class="content">
	...
	<h2>Receive email notifications</h2>
		...
		<form action="settings_handler.php" method="post">
			<div class="control mt-2">
				<input class="mb-3" type="text" name="new_username" placeholder="New Username" required>
				<button class="btn btn-main" type="submit">Submit</button>
			</div>
		</form>
		...
		<form action="settings_handler.php" method="post">
			<div class="control mt-2">
				<input class="mb-3" type="password" name="old_password" placeholder="Old password" required>
				<input class="mb-3" type="password" name="new_password" placeholder="New password" required>
				<button class="btn btn-main" type="submit">Submit</button>
			</div>
		</form>
	</div>
